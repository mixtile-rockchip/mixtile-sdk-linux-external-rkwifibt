...
#define REGULATION_COUNTRY_VERSION_8852B 48
...
const struct country_domain_mapping cdmap_8852b[] = {
    ...
    {0x0a, 0x00, {'I', 'Q'}, TPO_NA, 0x0f, 0, 0x00000000, 0x00000003, 0x00, 0}, /* 0058 */
    ...
    {0x0a, 0x00, {'R', 'U'}, TPO_NA, 0x0f, 0, 0x00000000, 0x00000003, 0x00, 0}, /* 0075 */
    ...
    {0x0a, 0x00, {'Y', 'E'}, TPO_NA, 0x0f, 0, 0x00000000, 0x00000003, 0x00, 0}, /* 0084 */
    ...
    {0x4b, 0x00, {'K', 'R'}, TPO_NA, 0x0f, 0, 0x00000000, 0x00000003, 0x00, 0}, /* 0092 */
    ...
    {0x0a, 0x00, {'A', 'F'}, TPO_NA, 0x0f, 0, 0x00000000, 0x00000003, 0x00, 0}, /* 0110 */
    {0x00, 0x00, {'D', 'Z'}, TPO_NA, 0x0f, 0, 0x00000000, 0x00000003, 0x00, 0}, /* 0111 */
    {0x0a, 0x00, {'A', 'S'}, TPO_NA, 0x0f, 0, 0x00000000, 0x00000003, 0x00, 0}, /* 0112 */
    ...
    {0x0a, 0x00, {'B', 'T'}, TPO_NA, 0x0f, 0, 0x00000000, 0x00000003, 0x00, 0}, /* 0126 */
    ...
    {0x0a, 0x00, {'V', 'G'}, TPO_NA, 0x0f, 0, 0x00000000, 0x00000003, 0x00, 0}, /* 0130 */
    ...
    {0x0a, 0x00, {'K', 'Y'}, TPO_NA, 0x0f, 0, 0x00000000, 0x00000003, 0x00, 1}, /* 0137 */
    ...
    {0x0a, 0x00, {'E', 'R'}, TPO_NA, 0x0f, 0, 0x00000000, 0x00000003, 0x00, 0}, /* 0150 */
    ...
    {0x0a, 0x00, {'K', 'I'}, TPO_NA, 0x0f, 0, 0x00000000, 0x00000003, 0x00, 0}, /* 0175 */
    ...
    {0x0a, 0x00, {'L', 'Y'}, TPO_NA, 0x0f, 0, 0x00000000, 0x00000003, 0x00, 0}, /* 0179 */
    ...
    {0x0a, 0x00, {'V', 'C'}, TPO_NA, 0x0f, 0, 0x00000000, 0x00000003, 0x00, 0}, /* 0210 */
    {0x0a, 0x00, {'W', 'S'}, TPO_NA, 0x0f, 0, 0x00000000, 0x00000003, 0x00, 0}, /* 0211 */
    ...
    {0x0a, 0x00, {'S', 'B'}, TPO_NA, 0x0f, 0, 0x00000000, 0x00000003, 0x00, 0}, /* 0216 */
    {0x0a, 0x00, {'S', 'O'}, TPO_NA, 0x0f, 0, 0x00000000, 0x00000003, 0x00, 0}, /* 0217 */
    ...
    {0x0a, 0x00, {'T', 'O'}, TPO_NA, 0x0f, 0, 0x00000000, 0x00000003, 0x00, 0}, /* 0226 */
    {0x3a, 0x00, {'T', 'M'}, TPO_NA, 0x0f, 0, 0x00000000, 0x00000003, 0x00, 0}, /* 0227 */
    {0x0a, 0x00, {'T', 'C'}, TPO_NA, 0x0f, 0, 0x00000000, 0x00000003, 0x00, 0}, /* 0228 */
    ...
    {0x0a, 0x00, {'I', 'R'}, TPO_NA, 0x01, 0, 0x00000000, 0x00000003, 0x00, 0}, /* 0237 */
};
