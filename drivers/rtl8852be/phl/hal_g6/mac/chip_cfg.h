...
#if defined(CONFIG_RTL8852C) || defined(CONFIG_RTL8832BRH) || defined(CONFIG_RTL8842A)
...
#if defined(CONFIG_RTL8852BT) || defined(CONFIG_RTL8852BPT)
#define MAC_AX_8852BT_SUPPORT	1
#define MAC_8852BT_SUPPORT
#else
