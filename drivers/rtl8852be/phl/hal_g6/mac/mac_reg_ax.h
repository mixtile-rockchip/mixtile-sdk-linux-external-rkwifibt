...
#define B_AX_IDMEM_SHARE_MODE_RECORD_SH 24
#define B_AX_IDMEM_SHARE_MODE_RECORD_MSK 0xf
...
// AON
//
#define B_AX_DIS_SWR_ANA_PRE_PWM BIT(6)
...
#define B_AX_PLCP_OPTION BIT(10)
