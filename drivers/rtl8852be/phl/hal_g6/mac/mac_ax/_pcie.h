...
#define PROC_100US_DLY 2
#define BASE_BOARD_ID_SHORT_LIST_NUM 33
#define BASE_BOARD_ID_100US_LIST_NUM 3
#define BASE_BOARD_ID_BER_LIST_NUM 3
...
/**
 * @brief proc_id_ber_setting_pcie
 *
 * @param *adapter
 * @return Please Place Description here.
 * @retval u32
